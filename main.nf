...
output:
 ...
 set val(namev),file("V_gapped_personal.fasta")  into g_25_germlineFastaFile1_g_26, g_25_germlineFastaFile1_g_30, g_25_germlineFastaFile1_g_40
...
if grep -q "_[0-9][0-9]*[A-Za-z][A-Za-z]*[0-9][0-9]*" ${v_germline_file}; then
	awk '/^>/{f=0} \$0 ~ /_[0-9][0-9]*[A-Za-z][A-Za-z]*[0-9][0-9]*/ {f=1} f' ${v_germline_file} > novel_sequences.fasta
